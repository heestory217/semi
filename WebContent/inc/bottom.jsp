		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 col-lg-3 footer_widget">
					<div class="inner">
						<div class="media">
							<a href="#"> <img src="<%=request.getContextPath() %>/assets/img/icons.JPG.png"
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6-bottom">
					<p>펀딩고는 플랫폼 제공자로서 프로젝트의 당사자가 아니며, 직접적인 통신판매를 진행하지 않습니다. 프로젝트의 완수
						및 선물제공의 책임은 해당 프로젝트의 창작자에게 있으며, 프로젝트와 관련하여 후원자와 발생하는 법적 분쟁에 대한 책임은
						해당 창작자가 부담합니다.</p>
					...
					<address>
						<em>&copy; Copyright</em> <a href="<%=request.getContextPath()%>/mainArticle.jsp">fundingo.co.kr</a>
