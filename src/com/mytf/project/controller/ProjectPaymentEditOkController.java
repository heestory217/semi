...
public class ProjectPaymentEditOkController implements Controller{
	private BankService bService;
	int result1=0;
	int result2=0;
	//boolean isExsist=false;

	public ProjectPaymentEditOkController() {
	...
	public String requestProcess(HttpServletRequest request, HttpServletResponse response) throws Throwable {
		...
		String msg="계좌정보 등록에 실패했습니다.", url="/projectManager/projectUpload.do?projectNo="+projectNo;
		try {
