				...
				<!--계좌 정보 폼 입력 시작 : bank 테이블 insert-->
					<div class="card">
						<div class="card-header py-4" id="heading-2-4"
							...
							aria-expanded="false" aria-controls="collapse-2-3">
							<h6 class="mb-0">4. 창작자 정보 및 계좌 설정</h6>
						</div>
						<div id="collapse-2-4" class="collapse"
							...
							<!--창작자 정보 수정 (회원 수정 페이지로 이동): /GoMember/memberEdit.do-->
				       		<p>※회원페이지에서 창작자 정보 및 정산계좌를 반드시 등록해주세요!</p>
							<div class="projectBox">
								<div>
							...
							<div style="text-align: center; margin: 20px 0;">
								<a href="<c:url value='/GoMember/memberPage.do'/>"><p class="button-2">회원정보 수정(계좌등록)하러 가기</p></a>
							</div>
					</div><!-- card -->
