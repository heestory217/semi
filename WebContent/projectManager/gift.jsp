...
<link
	...
	rel="stylesheet">
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/css/gift.css">
<link rel="stylesheet"
...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/css/projectUpload.css">
<link rel="stylesheet"
			...
			<div class="row">
				...
				<div class="logo-column">
					<a href="<%=request.getContextPath()%>/mainArticle.jsp"
						class="f_logo"> <img
						src="<%=request.getContextPath()%>/img/topLogo.png" alt="로고 이미지">
					</a>
				</div>
...
<body>
	...
	<div class="announce_g" style="margin-bottom: 20px;">
		<p>
			<img alt="notice" src="../icons/alert-circle.svg">&nbsp;&nbsp;프로젝트를
							...
							<div class="projectBox">
								<div>
									<div>
										...
										<p>
											프로젝트에 멋진 제목을 붙여주세요. <br>감정에 호소하는 제목보다는 만드시려는 창작물, 작품명,
											혹은 프로젝트의 주제가 드러나게 써주시는 것이 좋습니다.
										</p>
									...
									<div>
										...
										<p>
											프로젝트의 성격에 맞는 카테고리를 선택해 주세요. <br>(프로젝트 성격과 맞지 않는 카테고리를
											선택하실 시 후원자가 해당 프로젝트를 찾기 어려워지기에 에디터에 의해 조정될 수 있습니다.)
										</p>
							...
							<div class="projectBox">
								<div>
									<div>
										...
										사진을 올려주세요. <br>얼굴이 나온 사진을 넣으면 프로젝트의 신뢰성 향상에 도움이 됩니다. <br>
										파일 형식은 jpg, png 또는 gif로, 사이즈는 가로 200px, 세로 200px 이상으로 올려주세요. <br>
					...
					<div id="collapse-2-2" class="collapse"
						...
						<div class="card-body">
							...
							<div class="projectBox">
								<div>
									...
									<div>
										...
										<!-- 달력넣기 -->
										<p>
											공개일시 : <input type="text" id="startDay">
										</p>
										<!-- 시간넣기 -->
										에 펀딩을 시작합니다.
									</div>
									<div>
										...
										<p>
											...
											진행하실 수 있고 마감일 자정에 종료됩니다. <br>이미 선물을 만드셨다면, 선물 실행일 중에
							...
							<div class="projectBox">
								<div>
									<p>
										프로젝트 공개일 : <span style="color: #FF6F40; font-weight: bold;">2020년
											12월 22일</span>
									</p>
								</div>
							</div>
					...
					<div id="collapse-2-4" class="collapse"
						...
						<div class="card-body">
							...
							<div class="projectBox">
								<div>
									<div>
										<label for="hp">휴대폰 번호</label> <input type="text" name="hp">
									</div>
							...
							<div class="projectBox">
								<div>
									<div>
										<input type="radio" name="bank" value="private"><span
											style="margin-right: 30px;">개인</span> <input type="radio"
											name="bank" value="business">사업자(개인사업자 포함)
									</div>
									<br>
									<div>
										<label for="birth">예금주 생년월일</label> <input type="text"
											name="birth" maxlength="6">
									</div>

									<div>
										<label for="bankOwner">예금주명</label> <input type="text"
											name="bankOwner" maxlength="6">
									</div>

									<div>
										<label for="bankName">은행명</label> <input type="text"
											name="bankName" maxlength="6">
									</div>

									<div>
										<label for="bankName">계좌 번호</label> <input type="text"
											name="bankName" maxlength="16">
									</div>
								</div>
							</div>
